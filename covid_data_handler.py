...
def call_all() -> tuple:
    ...
    #print('running')
    covid_final_data = (local_data_7_days(capture_data), 
...
def schedule_covid_updates(update_interval:float, update_name:str, func_name:Callable= call_all)-> sched.Event:
